...
class Monster:
    ...
    def take_damage(self, damage):
        ...
        if remaining_points >= 0:
            ...
            print(
                "{} took {} points damage and has {} left.".format(
                    self.name, damage, self.hit_points
                )
            )
        else:
            self.lives -= 1
            ...
            if self.lives > 0:
                ...
                print(
                    "{} lost a life, took {} points damage, and reset to {} hit points.".format(
                        self.name, damage, self.hit_points
                    )
                )
    ...
    def __str__(self) -> str:
        return "Name : {}, Lives: {}, Hit points: {}".format(
            self.name, self.lives, self.hit_points
        )
...
class Troll(Monster):
    def __init__(
        self, name="Troll", hit_points=25, lives=1, damage=6, experience_reward=250
    ):
...
class Wolf(Monster):
    def __init__(
        self, name="Wolf", hit_points=22, lives=1, damage=5, experience_reward=200
    ):
        super().__init__(name, hit_points, lives, damage, experience_reward)
...
class Zombie(Monster):
    def __init__(
        self, name="Zombie", hit_points=20, lives=1, damage=5, experience_reward=200
    ):
        super().__init__(name, hit_points, lives, damage, experience_reward)
...
class Skeleton(Monster):
    def __init__(
        self, name="Skeleton", hit_points=15, lives=1, damage=4, experience_reward=150
    ):
        super().__init__(name, hit_points, lives, damage, experience_reward)
...
class Werewolf(Monster):
    def __init__(
        self, name="Werewolf", hit_points=30, lives=1, damage=8, experience_reward=300
    ):
        super().__init__(name, hit_points, lives, damage, experience_reward)
...
class Ghost(Monster):
    def __init__(
        self, name="Ghost", hit_points=18, lives=1, damage=3, experience_reward=180
    ):
        super().__init__(name, hit_points, lives, damage, experience_reward)
